...
def run_generate(args, init_code, model, prompt_template = None):
    ...
    if not matches: print(Fore.RED +f"The response from {args.model_name} does not include any code." + Fore.RESET)
...
if __name__ == '__main__':
    ...
    # python evaluation/baseline_Qwen25Coder-Deepseekv25_plus-mp.py --input_file if_test.json
    # python evaluation/baseline_Qwen25Coder-Deepseekv25_plus-mp.py --input_file if_test.json --experimental deepseek-v2.5-w-API-1-
    # python evaluation/baseline_Qwen25Coder-Deepseekv25_plus-mp.py --input_file if_test.json --experimental deepseek-v2.5-w-API-2-
